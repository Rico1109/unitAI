...
export const redMetricsDashboardTool = {
    ...
    execute: async (args, context) => {
        ...
        const filterInfo = [];
        if (component)
            filterInfo.push(`Component: ${component}`);
        if (backend)
            filterInfo.push(`Backend: ${backend}`);
...
//# sourceMappingURL=red-metrics-dashboard.tool.js.map