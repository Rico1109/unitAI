 ...
 */
export function toToon<T extends Record<string, any>>(
  data: T[],
  typeName: string,
  fields?: string[]
): string {
 ...
 */
export function singleToToon<T extends Record<string, any>>(
  data: T,
  typeName: string,
  fields?: string[]
): string {
 ...
 */
export function bundleToToon(bundle: ToonBundle): string {
